...
const SAMPLES = [
  {
    label: "AWS",
    page: "aws.html",
    script: "src/providers/aws/aws-specific.js",
  ...
  },
  {
    label: "Azure",
    page: "azure.html",
    script: "src/providers/azure/azure-specific.js",
    fn: "downloadAzureSampleCSV",
    dataScript: "src/providers/azure/azure-data.js",
  ...
  },
  {
    label: "GCP",
    page: "gcp.html",
    script: "src/providers/gcp/gcp-specific.js",
