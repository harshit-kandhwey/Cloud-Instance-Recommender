...
function downloadAzureSampleCSV() {
  const csvContent = `VM Name,App Name,CPU Count,Memory (GB),CPU Utilization,Memory Utilization,Azure Region,ENV,OS,Workload,Compliance,Min Gen,Exclude,Include Only,Current Instance Type
...
microservice-06,Analytics,1,2,15,20,East US,Dev,Linux,General,,,,"Dsv3,Fsv2",Standard_B1ms
