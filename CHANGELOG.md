...
| ------- | ------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.6.4   | _this commit_ | 2026-07-12 | Added a Copy button to the results preview: every row the filter matches, in the sort order shown, copied as tab-separated text that pastes straight into spreadsheet cells.                          |
