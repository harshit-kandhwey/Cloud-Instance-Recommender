...
| ------- | ------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.5.21  | _this commit_ | 2026-07-11 | Stopped downloads from silently disagreeing with the preview: an export now follows the sort order on screen, still contains every row when the preview is filtered, and the preview says so while a filter is active.                                                                                   |
