...
| ------- | ------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.6.5   | _this commit_ | 2026-07-12 | Rarely-used sections (the sample template, advanced filtering, usage statistics) now start collapsed, and every section remembers whether you opened or closed it, per page.                          |
