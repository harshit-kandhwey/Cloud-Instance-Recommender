...
| ------- | ------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.5.18  | _this commit_ | 2026-07-11 | Added RELEASING.md, writing down the release process end to end: where versions live, how a commit is mapped and tagged, how a minor line is published, and what to check before publishing.                                                                                                             |
