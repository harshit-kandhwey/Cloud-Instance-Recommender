...
| ------- | ------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.5.17  | _this commit_ | 2026-07-11 | Defined when a data refresh needs a service-worker cache bump (only when region files are removed, since a deleted file is served from cache forever) and made the split tool warn whenever it prunes one.                                                                                               |
