...
| ------- | ------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.6.8   | _this commit_ | 2026-07-12 | Fixed two regressions from this release's own work: the AWS bulk template no longer carries a UTF-8 BOM (the Pricing Calculator parses that file, and the BOM corrupted its first header), and the back-to-top button no longer hides underneath the toast stack. |
