...
| ------- | ------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.5.15  | _this commit_ | 2026-07-11 | Added the CI formatting gate: every push and pull request is checked with Prettier and the build fails on anything unformatted, so formatting is fixed locally and never by an untagged bot commit.                                                                                                      |
