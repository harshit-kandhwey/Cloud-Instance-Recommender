...
| ------- | ------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.5.12  | _this commit_ | 2026-07-11 | Removed the legacy upload pipeline, leaving a single ingest path: the duplicate file-input listener that raced the real one for the status, statistics, and preview panels is gone; drag-and-drop and the size/empty upload guards moved into that path; the unreachable integration hooks were deleted. |
