...
| ------- | ------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.6.7   | _this commit_ | 2026-07-12 | Gave the landing page a feature overview and a what's-new teaser linking to the changelog, so a first-time visitor can tell what the tool does without opening it.                                    |
