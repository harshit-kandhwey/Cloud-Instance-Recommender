...
| ------- | ------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.6.6   | _this commit_ | 2026-07-12 | Added a back-to-top button to the tool pages, and removed the page numbers from the user guide's contents — a leftover from when the guide was a PDF, and meaningless in a web page.                  |
