...
| ------- | ------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.6.10  | _this commit_ | 2026-07-12 | Addressed a review round: section collapse is keyed to a stable `data-section-id` rather than the heading text, the preview and the clipboard share one filter-and-sort function, and the guard against `alert()` returning now covers every module and would actually catch `window.alert(`. |
