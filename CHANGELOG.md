...
| ------- | ------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.6.9   | _this commit_ | 2026-07-12 | Recorded SHA-256 checksums for the vendored spreadsheet bundles, with a test that fails if one changes without its checksum, and replaced a scenario-durability test that could never fail with one that drives the real export path.                             |
...
| 3.6.5   | 1e15964       | 2026-07-12 | Rarely-used sections (the sample template, advanced filtering, usage statistics) now start collapsed, and every section remembers whether you opened or closed it, per page.                                                                                      |
