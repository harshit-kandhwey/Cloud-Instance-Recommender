...
| `Disk (GB)`                                      | Number (MB/MiB headers convert automatically)                                    | Optional provisioned disk; carried to the outputs and (rounded up to whole GB) the AWS bulk template. Does not affect sizing                             |
