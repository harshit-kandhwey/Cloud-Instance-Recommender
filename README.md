...
| `Disk (GB)`                                      | Number (MB/MiB headers convert automatically)                                    | Optional provisioned disk; carried as-is to the outputs, and rounded up to a whole GB for the AWS bulk template. Does not affect sizing                  |
