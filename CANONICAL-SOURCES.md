...
| ------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Per-provider price/spec field membership + emit order               | `tools/lib/record-schema.js` (`FIELD_ORDER`, `specFields()`, `priceFields()`)                                                    | `fetch-vantage.js`, `split-data.js`, `data-diff.js`, `reconcile-data.js`                                                                                                       | `data-integrity-test.js`, `split-data-test.js`, `record-schema-test.js`, `data-diff-test.js`, `reconcile-data-test.js`                                                                                                                                                                                                                                                      |
